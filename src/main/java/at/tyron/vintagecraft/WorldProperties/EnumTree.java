...
public enum EnumTree implements IEnumState {
	// (int weight, int mintemp, int maxtemp, int minrain, int maxrain, int minfertility, int maxfertility, float minheight, float maxheight)
	
	ASH						(0, 0,  0,  0,    0, 0,   0, 0f, 0f, 0, 255),
	BIRCH					(100, 3, 12, 95, 170, 10, 100, 0f, 0.5f, 0, 255),		// http://en.wikipedia.org/wiki/Birch
//	LARCH					(100, 0,  0,  0,    0, 0,   0, 0f, 0f),			// http://upload.wikimedia.org/wikipedia/commons/2/28/Larix_sibirica_-_Siperianlehtikuusi,_Sibirisk_l%C3%A4rk,_Siberian_larch_IMG_9213_C.JPG
	OAK						(5, 2, 22, 95,  150,  90,  255, 0f, 0.3f, 0, 150),  		// http://cdn1.arkive.org/media/4A/4A8E82BD-D487-4C74-805B-7C29A318029F/Presentation.Large/Sessile-oak-tree-in-winter.jpg
	MAPLE					(0, 0,  0,  0,    0, 0,   0, 0f, 0f, 0, 255),			// http://m3.i.pbase.com/u37/10kzoomfz/large/24239783.tree.jpg
	MOUNTAINDOGWOOD			(25, 10, 20, 90, 180,  90, 255, 0f, 0.5f, 0, 150),
...
//	APPLE					(100, 0,  0,  0,    0, 0,   0, 0f, 0f),			// http://www.gardenista.com/files/styles/733_0s/public/img/sub/uimg/01-2013/700_pruned-apple-tree-jpeg.jpg
	...
	SCOTSPINE				(100, -20,  12,  50,  150, 30, 255, 0f, 0.92f, 0, 255),			// http://www.treetopics.com/pinus_sylvestris/scots_pine_1220645.png | http://en.wikipedia.org/wiki/Scots_pine
...
//	PINYONPINE				(100, 0,  0,  0,    0, 0,   0, 0f, 0f),			// http://www.history.com/images/media/slideshow/new-mexico/new-mexico-state-tree-pinyon-pine.jpg  | http://images.fineartamerica.com/images-medium-large/pinyon-pine-tree-james-marvin-phelps.jpg
	...
	SPRUCE					(100, -12,  15,  50,  150,  60,  255, 0f, 0.8f, 0, 255),
...
//	BAOBAB					(100, 0,  0,  0,    0, 0,   0, 0f, 0f),
	ACACIA					(100, 20, 30, 100, 200, 50, 200, 0f, 0.5f, 0, 255),			// http://static.panoramio.com/photos/large/37061566.jpg
...
//	COCOATREE				(100, 0,  0,  0,    0, 0,   0, 0f, 0f),			// http://images.fineartamerica.com/images-medium-large/cacao-tree-granger.jpg
	...
	public static EnumTree getRandomTreeForClimate(int rainfall, int temperature, int forest, Random random) {
