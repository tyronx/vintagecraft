...
public class BlockFenceGateVC extends BlockFenceGate implements IMultiblock, ICategorizedBlockOrItem {
	...
	public Block registerMultiState(String blockclassname, Class<? extends ItemBlock> itemclass, IStateEnum[] types, String folderprefix) {
		...
		VintageCraft.proxy.ignoreProperties(this, new IProperty[] { POWERED });
