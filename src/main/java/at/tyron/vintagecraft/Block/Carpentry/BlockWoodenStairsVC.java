...
public class BlockWoodenStairsVC extends BlockStairs implements IMultiblock, ICategorizedBlockOrItem {
	public PropertyBlockClass TREETYPE;
	BlockClassEntry[] subtypes;

	public BlockWoodenStairsVC() {
    ...
    public static boolean isBlockStairs(Block block) {
        return block instanceof BlockWoodenStairsVC;
    }
