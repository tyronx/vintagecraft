...
import at.tyron.vintagecraft.WorldGen.NatFloat.Distribution;
...
public class EvolvingNatFloat {
	...
	public EvolvingNatFloat(float averagevalue, float variance, Distribution distribution, Function function, float factor) {
	...
	public static EvolvingNatFloat createIdentical(float value) {
		return new EvolvingNatFloat(value, 0f, Distribution.UNIFORM, Function.IDENTICAL, 0f);	
	}
	
	public static EvolvingNatFloat createUniform(float averagevalue, float variance, Function function, float factor) {
		return new EvolvingNatFloat(averagevalue, variance, Distribution.UNIFORM, function, factor);
	}
	
	public static EvolvingNatFloat createGauss(float averagevalue, float variance, Function function, float factor) {
		return new EvolvingNatFloat(averagevalue, variance, Distribution.GAUSSIAN, function, factor);
	}

	public static EvolvingNatFloat createInvGauss(float averagevalue, float variance, Function function, float factor) {
		return new EvolvingNatFloat(averagevalue, variance, Distribution.INVERSEGAUSSIAN, function, factor);
	}

	public static EvolvingNatFloat createTri(float averagevalue, float variance, Function function, float factor) {
		return new EvolvingNatFloat(averagevalue, variance, Distribution.TRIANGLE, function, factor);
	}
	
	public static EvolvingNatFloat createDirac(float averagevalue, float variance, Function function, float factor) {
		return new EvolvingNatFloat(averagevalue, variance, Distribution.DIRAC, function, factor);
	}

	public static EvolvingNatFloat create(float averagevalue, float variance, Distribution distribution, Function function, float factor) {
