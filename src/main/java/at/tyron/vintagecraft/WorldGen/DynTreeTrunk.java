...
public class DynTreeTrunk {
	...
	public DynTreeTrunk(float width, float widthloss, NatFloat branchStart, NatFloat branchSpacing, NatFloat verticalAngle, NatFloat horizontalAngle, EvolvingNatFloat numBranching, float branchWidthMultiplier) {
	...
	public DynTreeTrunk(float width, float widthloss, NatFloat branchStart, NatFloat branchSpacing, NatFloat verticalAngle, NatFloat horizontalAngle, EvolvingNatFloat numBranching, float branchWidthMultiplier, float widthBranchLossBase) {
	...
	public DynTreeTrunk(float width, float widthloss, NatFloat branchStart, NatFloat branchSpacing, NatFloat verticalAngle, NatFloat horizontalAngle, EvolvingNatFloat numBranching, float branchWidthMultiplier, float widthBranchLossBase, EvolvingNatFloat angleVert/*, EvolvingNatFloat bendAngleVert*/) {
