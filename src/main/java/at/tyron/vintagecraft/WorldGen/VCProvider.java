...
public class VCProvider extends WorldProvider {
	...
	public IChunkProvider createChunkGenerator() {
		return new VCChunkProviderGenerate(worldObj, worldObj.getSeed(), worldObj.getWorldInfo().isMapFeaturesEnabled(), null);
	}
