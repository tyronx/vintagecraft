...
public class Noisy {
	...
	public float perlinNoise2D(float x, float y, int octaves, float persistence) {
		this.octaves = octaves;
		this.persistence = persistence;
