...
public class GenLayerClampedSubstract extends GenLayerVC {
	...
	public GenLayerClampedSubstract(long seed, int rgbselect, int mode, GenLayerVC targetImage, GenLayerVC substractImage) {
		this(seed, rgbselect, rgbselect, mode, targetImage, substractImage);
	}

	public GenLayerClampedSubstract(long seed, int rgbselecttarget, int rgbselectsubstract, int mode, GenLayerVC targetImage, GenLayerVC substractImage) {
		super(seed);
		this.mode = mode;
