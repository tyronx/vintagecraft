...
public class EntityEmptyMinecartVC extends EntityMinecartVC {
	   public EntityEmptyMinecartVC(World worldIn) {
	        super(worldIn);
	    }

	    public EntityEmptyMinecartVC(World worldIn, double p_i1723_2_, double p_i1723_4_, double p_i1723_6_) {
